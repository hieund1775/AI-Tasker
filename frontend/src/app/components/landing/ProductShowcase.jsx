    ...
    <div className="space-y-3">
      {["Full-stack AI Engineer", "ML Ops Specialist", "Data Scientist"].map((name, index) => (
        <div key={name} className="flex items-center gap-3 rounded-xl border border-border bg-card p-3">
          ...
          <span className="rounded-lg bg-success-light px-2 py-1 text-[10px] font-semibold text-success">{92 - index * 7}%</span>
        </div>
      ))}
    </div>
  );
...
function DashboardMockup() {
  return (
    <div className="space-y-4">
      ...
      <div className="flex h-20 items-end gap-1.5 rounded-xl border border-border bg-card p-3">
...
function MessagesMockup() {
  return (
    <div className="space-y-3">
      <div className="max-w-[72%] rounded-xl rounded-bl-md bg-secondary p-3">
      ...
      <div className="ml-auto max-w-[78%] rounded-xl rounded-br-md bg-primary p-3">
    ...
    <section className="relative overflow-hidden bg-background px-4 py-[var(--section-y)] sm:px-6 lg:px-8">
      <div className="relative mx-auto max-w-[1180px]">
        ...
        >
          ...
          <h2 className="text-2xl font-semibold tracking-[-0.01em] text-foreground sm:text-3xl">Everything needed to manage AI project work</h2>
        ...
        <div className="mt-12 rounded-2xl border border-border bg-card p-6 shadow-sm">
          <div className="grid gap-4 md:grid-cols-4">
            {[
              ...
              <div key={stat.label} className="flex items-center gap-3 rounded-xl bg-secondary/60 p-4">
