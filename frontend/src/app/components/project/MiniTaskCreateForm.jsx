    ...
    <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          {miniTasks.map((mt, idx) => (
            ...
            >
              ...
              <GripVertical className="w-4 h-4 text-muted-foreground/60 flex-shrink-0 mt-1" />
              ...
              {editingId === mt.id ? (
                <div className="flex-1 space-y-2">
                  <input
                    ...
                    className="w-full px-2 py-1 text-sm border border-input rounded-lg focus:outline-none focus:border-brand-primary"
                    placeholder="Title"
                    autoFocus
                  />
                  <input
                    ...
                    className="w-full px-2 py-1 text-xs border border-input rounded-lg focus:outline-none focus:border-brand-primary"
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-medium text-foreground">{mt.title}</p>
                  {mt.description && (
      ...
      <div className="space-y-2 p-3 bg-brand-primary-light/50 rounded-lg border border-brand-primary/20">
        ...
        <input
          ...
          className="w-full px-3 py-2 text-xs border border-input rounded-lg focus:outline-none focus:border-brand-primary"
          placeholder="Description (optional)"
        />
        <input
          type="text"
        ...
        <div className="flex items-center justify-between pt-1">
          <button
            ...
            onClick={handleAdd}
            disabled={!title.trim()}
            className="px-5 py-2 bg-brand-primary text-brand-primary-foreground rounded-xl hover:bg-brand-primary-hover disabled:bg-muted/80 disabled:cursor-not-allowed text-[15px] font-medium inline-flex items-center gap-2 transition"
          >
