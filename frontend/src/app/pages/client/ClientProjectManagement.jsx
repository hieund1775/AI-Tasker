  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 font-sans space-y-6">
      ...
      {showCancelModal && (() => {
        ...
        return (
          <div data-modal-overlay className="fixed inset-0 z-[99999] flex items-center justify-center p-3 sm:p-5 bg-black/75 backdrop-blur-md overflow-hidden transition-all animate-fade-in">
            <div className="relative bg-card rounded-2xl border border-destructive/30 shadow-2xl w-full max-w-xl max-h-[85vh] my-auto flex flex-col overflow-hidden text-left transform transition-all scale-100 animate-zoom-in font-sans">
              {/* Header */}
              ...
              <div className="flex-1 min-h-0 overflow-y-auto p-4 space-y-3 text-sm font-sans">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 rounded-2xl border border-border bg-secondary/35 p-2.5">
                  ...
                  <div className="rounded-xl border border-warning/25 bg-warning-light/45 p-2">
                    ...
                    <span className="mt-1 block text-xs sm:text-sm font-semibold text-warning"><MoneyDisplay amount={expertPayout} /></span>
                  </div>
                  <div className="rounded-xl border border-success/25 bg-success-light/50 p-2">
                    ...
                    <span className="mt-1 block text-xs sm:text-sm font-semibold text-success"><MoneyDisplay amount={clientRefund} /></span>
                  </div>
                </div>
