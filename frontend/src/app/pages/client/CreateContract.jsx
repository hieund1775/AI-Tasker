      ...
      <div className="bg-card rounded-2xl border border-border shadow-sm overflow-hidden">
        ...
        <div className="p-8 space-y-8">
          ...
          <section>
            ...
            <div className="bg-secondary rounded-xl p-4">
              <p className="text-xs text-muted-foreground mb-1">Proposal Summary</p>
              {(() => {
                let intro = "";
                try {
          ...
          <section>
            ...
            <textarea
              ...
              rows={6}
              className="w-full px-4 py-2.5 border border-input rounded-xl focus:outline-none focus:border-ring text-sm leading-relaxed"
        ...
        <div className="p-8 border-t border-border-light bg-secondary/50">
          <div className="flex items-center justify-between flex-wrap gap-4">
            ...
            <button
              ...
              disabled={submitting}
              className="px-6 py-2.5 bg-primary text-primary-foreground rounded-xl hover:bg-primary-hover font-medium text-sm inline-flex items-center gap-2 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
