...
export function AdminRevenue() {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
          ...
          ? [
              {
                id: `tx-${i}-escrow`,
                type: "escrow_deposit",
                amount: m.escrowProcessed,
                from: "Clients",
                to: "Escrow",
                project: `${m.month} total`,
                date: `${m.month}-15`,
              },
            ]
          : []),
      ...
      const thisMonthData = months[months.length - 1] || {
        fees: 0,
        escrowProcessed: 0,
      };
      const lastMonthData = months[months.length - 2] || {
        fees: 0,
        escrowProcessed: 0,
      };
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <p className="text-gray-600 mb-8">
        Platform revenue summary and transaction audit log.
      </p>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        {[
          {
            label: "Total Revenue",
            value: <MoneyDisplay amount={s.totalRevenue} />,
            icon: TrendingUp,
            color: "text-green-600 bg-green-100",
          },
          {
            label: "This Month",
            value: <MoneyDisplay amount={s.thisMonth} />,
            icon: BarChart3,
          ...
          {
            label: "In Escrow",
            value: <MoneyDisplay amount={s.escrowHeld} />,
            icon: DollarSign,
            color: "text-purple-600 bg-purple-100",
          },
          {
            label: "Paid to Experts",
            value: <MoneyDisplay amount={s.paidToExperts} />,
            icon: ArrowUpRight,
