          ...
          >
            <div className="flex-1">
              ...
              <input
                ...
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-900 text-sm disabled:bg-gray-100 disabled:cursor-not-allowed"
              />
            </div>
            <button
              type="submit"
              disabled={addingSkill || !newSkillName.trim()}
              className="inline-flex items-center gap-1.5 px-4 py-2 bg-blue-900 text-white rounded-lg text-sm font-medium hover:bg-blue-800 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
              {addingSkill ? (
                <>
                  <svg
          ...
          <DataTable
            ...
            actions={(row) => (
              <button
                ...
                disabled={deleting}
                className="px-3 py-1.5 rounded-lg text-xs font-medium inline-flex items-center gap-1.5 bg-red-50 text-red-700 hover:bg-red-100 border border-red-200 transition disabled:opacity-50 disabled:cursor-not-allowed"
              >
