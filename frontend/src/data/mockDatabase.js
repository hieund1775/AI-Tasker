...
const _baseReports = [
  ...
  },
  {
    ...
    desiredResolution: "2-week deadline extension and 2.000 VND additional budget for compliance work",
    evidence: [{ fileName: "compliance_checklist.pdf", note: "SOC2 requirements from security team" }],
    status: "Resolved",
    adminNote: "SOC2 requirements were legitimate. 2-week extension and 2.000 VND budget increase approved.",
    reporterRole: "expert",
    reportType: "type2",
  ...
  },
  {
    ...
    description: "The client provided transaction data that was significantly dirtier than described - 40% missing values, inconsistent date formats, and duplicate records. I had to build extensive data cleaning pipelines that took 3 weeks instead of the estimated 1 week. Requesting 3.000 VND additional compensation.",
    disputeType: "financial",
    desiredResolution: "3.000 VND additional budget for data cleaning work",
...
const _baseNotifications = [
  ...
  { id: "notif-002", userId: "user-005", title: "Payment Released", message: "8.500 VND has been released from escrow for 'Sentiment Analysis Pipeline'.", type: "payment", isRead: true, linkTo: "/expert/wallet", createdAt: "2026-03-28T15:00:00.000Z" },
  ...
  { id: "notif-004", userId: "user-005", title: "Withdrawal Processed", message: "Your withdrawal of 5.000 VND has been processed and will arrive in 2-3 business days.", type: "payment", isRead: true, linkTo: "/expert/wallet", createdAt: "2026-05-02T10:00:00.000Z" },
  ...
  { id: "notif-017", userId: "user-010", title: "Payment Released", message: "12.000 VND has been released for 'Fraud Detection Phase 1'.", type: "payment", isRead: true, linkTo: "/expert/wallet", createdAt: "2026-04-20T17:00:00.000Z" },
  ...
  { id: "notif-020", userId: "user-012", title: "Payment Released", message: "10.000 VND has been released for 'Adaptive Learning MVP'. Great work!", type: "payment", isRead: true, linkTo: "/expert/wallet", createdAt: "2026-05-10T13:00:00.000Z" },
  { id: "notif-021", userId: "user-012", title: "Withdrawal Pending", message: "Your withdrawal request of 8.000 VND is being processed.", type: "payment", isRead: false, linkTo: "/expert/wallet", createdAt: "2026-06-14T08:30:00.000Z" },
  ...
  { id: "notif-033", userId: "user-001", title: "Revenue Report Ready", message: "Monthly revenue report for June 2026 is ready. Total platform revenue: 156.500 VND with 8 completed projects.", type: "system", isRead: false, linkTo: "/owner/dashboard", createdAt: "2026-06-16T09:00:00.000Z" },
  ...
  { id: "notif-038", userId: "user-011", title: "Payment Released", message: "16.000 VND has been released from escrow for 'Virtual Staging AI'. Great work!", type: "payment", isRead: true, linkTo: "/expert/wallet", createdAt: "2026-04-28T15:30:00.000Z" },
  ...
  { id: "notif-044", userId: "user-016", title: "Payment Released", message: "10.000 VND escrow has been released to Henry Davis for 'Adaptive Learning MVP'.", type: "payment", isRead: true, linkTo: "/client/billing", createdAt: "2026-05-10T13:00:00.000Z" },
  { id: "notif-045", userId: "user-016", title: "New Expert Available", message: "Top-rated NLP expert Carol Zhang is now available for new projects. Her rate: 110 VND/hr.", type: "system", isRead: false, linkTo: "/client/experts/user-007", createdAt: "2026-06-14T08:00:00.000Z" },
  ...
  { id: "notif-051", userId: "user-018", title: "Refund Processed", message: "14.000 VND has been refunded to your wallet from cancelled project 'Property Valuation ML'.", type: "payment", isRead: false, linkTo: "/client/billing", createdAt: "2026-06-10T14:45:00.000Z" },
  { id: "notif-052", userId: "user-020", title: "Payment Released", message: "8.500 VND escrow has been released to Alice Johnson for 'Sentiment Analysis Pipeline'.", type: "payment", isRead: true, linkTo: "/client/billing", createdAt: "2026-03-28T14:30:00.000Z" },
  ...
  { id: "notif-054", userId: "user-020", title: "Refund Processed", message: "9.500 VND has been refunded from cancelled project 'Marketing Content Generator'.", type: "payment", isRead: false, linkTo: "/client/billing", createdAt: "2026-06-15T09:45:00.000Z" },
];
...
const _baseMessages = [
  ...
  { id: "msg-018", senderId: "user-020", receiverId: "user-011", projectId: null, content: "We're looking at an AI content assistant for our mobile app - personalized push notifications, in-app content recommendations, and visual search. Budget around 12.000-15.000 VND.", isRead: false, createdAt: "2026-06-16T09:00:00.000Z" },
  ...
  { id: "msg-023", senderId: "user-016", receiverId: "user-012", projectId: "proj-010", content: "Perfect! Let's schedule a call next week to go through the scope. Budget for Phase 2 is approved at 25.000 VND.", isRead: false, createdAt: "2026-05-21T14:00:00.000Z" },
...
export function checkProposalDeadlines() {
  try {
    ...
    proposals.forEach((prop) => {
      ...
      const createdAt = new Date(prop.createdAt || now);
