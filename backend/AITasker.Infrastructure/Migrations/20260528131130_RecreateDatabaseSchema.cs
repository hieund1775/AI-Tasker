...
{
    /// <inheritdoc />
    public partial class RecreateDatabaseSchema : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReputationCredit = table.Column<decimal>(type: "decimal(3,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AICategoryDomainExpertProfile_AICategoryDomains_AICategoryDomainsId",
                        column: x => x.AICategoryDomainsId,
                        principalTable: "AICategoryDomains",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AICategoryDomainExpertProfile_ExpertProfiles_ExpertProfilesUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AICategoryDomainExpertProfile_ExpertProfilesUserId",
