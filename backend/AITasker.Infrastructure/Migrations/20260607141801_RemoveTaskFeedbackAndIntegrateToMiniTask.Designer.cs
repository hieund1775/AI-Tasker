...
namespace AITasker.Infrastructure.Migrations
{
    ...
    [Migration("20260607141801_RemoveTaskFeedbackAndIntegrateToMiniTask")]
    partial class RemoveTaskFeedbackAndIntegrateToMiniTask
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AITasker.Domain.Entities.Conversation", b =>
                {
                    ...
                    b.HasOne("AITasker.Domain.Entities.JobPost", "OriginJobPost")
                        .WithMany()
