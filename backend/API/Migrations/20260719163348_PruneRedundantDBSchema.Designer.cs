...
namespace AITasker_Modular.Migrations
{
    ...
    [Migration("20260719163348_PruneRedundantDBSchema")]
    partial class PruneRedundantDBSchema
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AITasker_Modular.Database.SystemWallet", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            TotalBalance = 0m,
                            UpdatedAt = new DateTime(2026, 7, 19, 16, 33, 45, 29, DateTimeKind.Utc).AddTicks(5750)
                        });
                });
