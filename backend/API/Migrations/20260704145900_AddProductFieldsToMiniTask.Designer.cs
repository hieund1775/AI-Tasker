...
namespace AITasker_Modular.Migrations
{
    ...
    [Migration("20260704145900_AddProductFieldsToMiniTask")]
    partial class AddProductFieldsToMiniTask
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AITasker_Modular.Database.SystemWallet", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            TotalBalance = 0m,
                            UpdatedAt = new DateTime(2026, 7, 4, 14, 58, 58, 600, DateTimeKind.Utc).AddTicks(4778)
                        });
                });
