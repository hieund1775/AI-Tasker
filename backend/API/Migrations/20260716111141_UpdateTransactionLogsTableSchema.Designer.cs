...
namespace AITasker_Modular.Migrations
{
    ...
    [Migration("20260716111141_UpdateTransactionLogsTableSchema")]
    partial class UpdateTransactionLogsTableSchema
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AITasker_Modular.Database.SystemWallet", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            TotalBalance = 0m,
                            UpdatedAt = new DateTime(2026, 7, 16, 11, 11, 38, 828, DateTimeKind.Utc).AddTicks(3275)
                        });
                });
