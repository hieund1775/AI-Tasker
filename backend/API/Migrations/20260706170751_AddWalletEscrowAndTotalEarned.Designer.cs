...
namespace AITasker_Modular.Migrations
{
    ...
    [Migration("20260706170751_AddWalletEscrowAndTotalEarned")]
    partial class AddWalletEscrowAndTotalEarned
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AITasker_Modular.Database.SystemWallet", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            TotalBalance = 0m,
                            UpdatedAt = new DateTime(2026, 7, 6, 17, 7, 47, 866, DateTimeKind.Utc).AddTicks(9840)
                        });
                });
