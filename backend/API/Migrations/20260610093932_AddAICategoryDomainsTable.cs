...
{
    /// <inheritdoc />
    public partial class AddAICategoryDomainsTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "AICategoryDomains",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AICategoryDomains", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    AICategoryDomainId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_JobPosts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_JobPosts_AICategoryDomains_AICategoryDomainId",
                        column: x => x.AICategoryDomainId,
                        principalTable: "AICategoryDomains",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                name: "AICategoryDomainExpertProfile",
                columns: table => new
                {
                    AICategoryDomainsId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ExpertProfilesUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AICategoryDomainId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ExpertProfileUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AICategoryDomainExpertProfile", x => new { x.AICategoryDomainsId, x.ExpertProfilesUserId });
                    table.ForeignKey(
                        name: "FK_AICategoryDomainExpertProfile_AICategoryDomains_AICategoryDomainId",
                        column: x => x.AICategoryDomainId,
                        principalTable: "AICategoryDomains",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AICategoryDomainExpertProfile_ExpertProfiles_ExpertProfileUserId",
                        column: x => x.ExpertProfileUserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AICategoryDomainExpertProfile_AICategoryDomainId",
                table: "AICategoryDomainExpertProfile",
                column: "AICategoryDomainId");

            migrationBuilder.CreateIndex(
                name: "IX_AICategoryDomainExpertProfile_ExpertProfileUserId",
                table: "AICategoryDomainExpertProfile",
                column: "ExpertProfileUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobPosts_AICategoryDomainId",
                table: "JobPosts",
                column: "AICategoryDomainId");
