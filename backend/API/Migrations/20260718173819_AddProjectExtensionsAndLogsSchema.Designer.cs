...
namespace AITasker_Modular.Migrations
{
    ...
    [Migration("20260718173819_AddProjectExtensionsAndLogsSchema")]
    partial class AddProjectExtensionsAndLogsSchema
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AITasker_Modular.Database.SystemWallet", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            TotalBalance = 0m,
                            UpdatedAt = new DateTime(2026, 7, 18, 17, 38, 17, 77, DateTimeKind.Utc).AddTicks(702)
                        });
                });
