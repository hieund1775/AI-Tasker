    ...
    "MiniTasks": [
      {
        ...
        "Description": "string -- a concise 1-2 sentence explanation of what this feature does and why it is needed, written clearly enough for the Expert to understand the requirement and start scoping the work."
      }
    ]
  }
]
...
7. Keep each "Description" short and focused (1-2 sentences) -- it exists to clarify the requirement for the Expert, not to be a full specification.
